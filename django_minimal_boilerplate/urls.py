"""django_minimal_boilerplate URL Configuration
...
from django_minimal_boilerplate.router import OptionalSlashDefaultRouter
...
schema_view = get_schema_view(
    openapi.Info(
        ...
        default_version='v1',
        description="Minimal django boilerplate",
